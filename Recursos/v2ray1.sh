...
funINIT() {
[[ $1 == 1 ]] && {
echo 'source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/v2ray1.sh)' > /bin/v2ray.menu
...
intallv2ray () {
install_ini
source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/v2ray.sh)
...
unistallv2 () {
source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/v2ray.sh) --remove > /dev/null 2>&1
...
3)estarts;;
0)
source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/v2ray1.sh)
;;
esac
}
