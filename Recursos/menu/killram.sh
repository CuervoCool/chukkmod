...
wget -q -O /bin/ejecutar/msg https://raw.githubusercontent.com/CuervoCool/chukkmod/main/msg-bar/msg
[[ -e /bin/ejecutar/autt ]] && { 
name=$(cat < /bin/ejecutar/autt)
echo "Haciendo COPIA DE USUARIOS EN $name " $tiempo >> /root/lm.log
source <(curl -sL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu/autobackup.sh) 
} || {
