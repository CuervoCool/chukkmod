...
unset port
  ...
  case $opcion in
  1) source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/UDPserver.org.sh) && exit;;
  2) source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/udp-custom.sh) && exit;;
