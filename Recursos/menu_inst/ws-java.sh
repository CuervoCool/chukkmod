...
wget -q https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/ws-java-sh/proxy3.js
...
wget -O httpsProxy.js -q https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/ws-java-sh/proxy3.js
