...
wget -O $HOME/PDirect80.py 'https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/autoconfig-sh/PDirect.py'
...
sleep 1
			...
			;;
			2)
			source <(curl -sSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/autoconfig-sh/Proxy.sh)
			;;			
			3)
