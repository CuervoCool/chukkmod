...
menu_org () {
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/openvpnmenu.sh)"
}
...
source <(curl -sL https://raw.githubusercontent.com/CuervoCool/chukkmod/main/msg-bar/msg)
wget -O /tmp/openvpn.sh -q https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu_inst/openvpnmenu.sh && chmod +x /tmp/openvpn.sh && cd /tmp && ./openvpn.sh && cd
